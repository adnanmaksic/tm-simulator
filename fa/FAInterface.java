...
public interface FAInterface {
	...
	/**
	 * String to be filled out of the alphabet residing in the turing language
	 * @param name
	 * @return true if the tape is complete, false if the tape is not complete
	 */
	public boolean tape(Tape name);
